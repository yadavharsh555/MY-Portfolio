  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-400 mt-4 max-w-2xl text-center">
        I am <span className="text-yellow-400">Harsh Yadav</span>, a dedicated <strong>Python Developer</strong> with a passion for building web applications, Analyze Data, solving problems, and continuously expanding my technical skill set.
      </p>
      ...
      >
        My goal is to leverage my skills in <strong>Python Devlopment ,full-stack development, Data Analyst, and automation</strong> to contribute to innovative projects. I'm eager to work in dynamic environments where I can grow and make meaningful impacts.
      </motion.p>
      ...
      >
        ...
        <div className="text-gray-300 mt-4 space-y-1">
          ...
          <p><strong>Frameworks & Libraries:</strong> React.js, Express.js, Node.js, Tailwind CSS, Flask, Data Analyst - Matplotlib, Numpy, Pandas, </p>
          <p><strong>Databases:</strong> MongoDB, SQL, MySQl, DBMS</p>
          <p><strong>Tools & Platforms:</strong> GitHub, VS Code, Jupyter Notebook,Excel</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <p className="text-gray-300 mt-4">🎓 <strong>LNCT University, Bhopal</strong> — B.Tech in Computer Science (2022 - 2026) | CGPA: <strong>7.36</strong></p>
